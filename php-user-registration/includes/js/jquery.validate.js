...
$(document).ready(function() {
				...
				$('#file').click(function(){
					$('.submit').click(function(){
						$("#progressbar-container").css("display","block");
						 ...
						 $("#progressbar-fill").animate({width: '0'},20,'linear',function(){}); // progress starting
						 $("#progressbar-fill").animate({width: '200'},'linear',function(){$("#progressbar").fadeOut(1000);$("#progressbar").css("overflow", "visible");});  // progress ending
					 });
			});	
	...
	// validate registration form on keyup and submit
		...
		messages: {
				...
				age: {
								...
								range: "Please enter the age within the range 5 to 99."
			},
				password: {
	...
	var topics = $("#newsletter_topics")[inital ? "removeClass" : "addClass"]("gray","error2");
